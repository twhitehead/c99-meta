...
#define _list_map(f,xs,...)             reduce_LazyCase1(list_map,xs,f,__VA_ARGS__)
...
#define _list_append(xs,ys,...)             reduce_LazyCase1(list_append,xs,ys,__VA_ARGS__)
...
#define _list_filter(f,xs,...)                        reduce_LazyCase1(list_filter,xs,f,__VA_ARGS__)
#define _list_filter_list_Cons(x,xs,f,...)            reduce_LazyCase1(list_filter_list_Cons,(f,x),f,x,xs,__VA_ARGS__)
#define _list_filter_list_Cons_bool_True(f,x,xs,...)  reduce_Construct((list_Cons,x,(filter,f,xs)),__VA_ARGS__)
#define _list_filter_list_Cons_bool_False(f,x,xs,...) reduce_Return((list_filter,f,xs),__VA_ARGS__)
#define _list_filter_list_Nil(f,...)                  reduce_Construct((list_Nil),__VA_ARGS__)

#define _list_concat(xss,...) reduce_Return((list_foldr,append,(list_Nil),xss),__VA_ARGS__)

#define _list_head(xs,...)             reduce_LazyCase1(list_head,xs,__VA_ARGS__)
#define _list_head_list_Cons(x,xs,...) reduce_Return(x,__VA_ARGS__)
#define _list_head_list_Nil(...)       Error("list_head: empty list")

#define _list_tail(xs,...)             reduce_LazyCase1(list_tail,xs,__VA_ARGS__)
#define _list_tail_list_Cons(x,xs,...) reduce_Return(xs,__VA_ARGS__)
#define _list_tail_list_Nil(...)       Error("list_tail: empty list")

#define _list_last(xs,...)                           reduce_LazyCase1(list_last,xs,__VA_ARGS__)
#define _list_last_list_Cons(x,xs,...)               reduce_LazyCase1(list_last_list_Cons,xs,x,__VA_ARGS__)
#define _list_last_list_Cons_list_Cons(x1,xs,x0,...) reduce_LazyCase1(list_last_list_Cons,xs,x1,__VA_ARGS__)
#define _list_last_list_Cons_list_Nil(x0,...)        reduce_Return(x0,__VA_ARGS__)
#define _list_last_list_Nil(...)                     Error("list_last: empty list")

#define _list_init(xs,...)                           reduce_LazyCase1(list_init,xs,__VA_ARGS__)
#define _list_init_list_Cons(x,xs,...)               reduce_LazyCase1(list_init_list_Cons,xs,x,__VA_ARGS__)
...
#define _list_init_list_Nil(...)                     Error("list_init: empty list")

#define _list_foldl(f,y,xs,...)             reduce_LazyCase1(list_foldl,xs,f,y,__VA_ARGS__)
#define _list_foldl_list_Cons(x,xs,f,y,...) reduce_Return((list_foldl,f,(f,y,x),xs),__VA_ARGS__)
#define _list_foldl_list_Nil(f,y,...)       reduce_Return(y,__VA_ARGS__)

#define _list_foldl1(f,xs,...)             reduce_LazyCase1(list_foldl1,xs,f,__VA_ARGS__)
#define _list_foldl1_list_Cons(x,xs,f,...) reduce_Return((list_foldl,f,x,xs),__VA_ARGS__)
#define _list_foldl1_list_Nil(...)         Error("list_foldl1: empty list")

#define _list_foldr(f,y,xs,...)             reduce_LazyCase1(list_foldr,xs,f,y,__VA_ARGS__)
...
#define _list_foldr1(f,xs,...)                           reduce_LazyCase1(list_foldr1,xs,f,__VA_ARGS__)
#define _list_foldr1_list_Cons(x,xs,f,...)               reduce_LazyCase1(list_foldr1_list_Cons,xs,f,x,__VA_ARGS__)
...
#define _list_foldr1_list_Nil(...)                       Error("list_foldr1: empty list")


#define _equal_equal_list_Cons_list_Cons(x,xs,y,ys,...) reduce_Return((bool_and,(equal_equal,x,y),(equal_equal,xs,ys)),__VA_ARGS__)
...
#define _order_compare_list_Cons_list_Cons(x,xs,y,ys,...)      reduce_LazyCase1(order_compare_list_Cons_list_Cons,(order_compare,x,y),xs,ys,__VA_ARGS__)
#define _order_compare_list_Cons_list_Cons_order_LT(xs,ys,...) reduce_Construct((order_LT),__VA_ARGS__)
#define _order_compare_list_Cons_list_Cons_order_EQ(xs,ys,...) reduce_Return((order_compare,xs,ys,__VA_ARGS__))
