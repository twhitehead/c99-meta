...
#define _integer_quotientRemainder_N_P(x,y,...) reduce_Lazy2(integer_quotientRemainder0,(integer_add_,     (N,N),y),(reduce_Lazy1,integer_quotientRemainder_reverse,(integer_subtract_,x,(P,1,P))),(N,N),y,integer_subtract_,integer_add_,1,0,__VA_ARGS__)
#define _integer_quotientRemainder_P_N(x,y,...) reduce_Lazy2(integer_quotientRemainder0,(integer_add_,     (P,P),y),(              integer_quotientRemainder_reverse,x),                            (N,N),y,integer_add_,integer_subtract_,0,1,__VA_ARGS__)
...
#define _order_lesser_integer_Integer_integer_Integer(x,y,...)       reduce_Return((integer_compare_,x,y,(bool_True), (bool_False),(bool_False)),__VA_ARGS__)
#define _order_lesserequal_integer_Integer_integer_Integer(x,y,...)  reduce_Return((integer_compare_,x,y,(bool_True), (bool_True), (bool_False)),__VA_ARGS__)
#define _order_greaterequal_integer_Integer_integer_Integer(x,y,...) reduce_Return((integer_compare_,x,y,(bool_False),(bool_True), (bool_True)), __VA_ARGS__)
#define _order_greater_integer_Integer_integer_Integer(x,y,...)      reduce_Return((integer_compare_,x,y,(bool_False),(bool_False),(bool_True)), __VA_ARGS__)
